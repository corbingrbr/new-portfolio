...
export default function ProjectView2({ projects }) {
  ...
  if (!project) {
    ...
    return (
      <div className="py-5 max-w-screen-xl h-screen mx-auto grid grid-cols-1">
        ...
        <div className="bg-white m-8 h-full overflow-hidden">
          ...
          <div className="p-8 lg:grid lg:grid-cols-2 lg:gap-x-8 ">
            ...
            <div className="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 ">
              <p>
                This will be the section I provided all the additional details I
                want to discuss about the project. Possibly a code snippet or
                two here.
              </p>
              <div className="lg:self-start text-left">
                <CodeBlock
                  text={`const add = (x: number, y: number): number => x + y;\nconst sub = (x: number, y: number): number => x - y;`}
                  language={"typescript"}
